...
export function IsgForm({ personelId }: { personelId: number }) {
  ...
  return (
    <>
      ...
      >
        <Icon name="plus" size={13} className="mr-0.5 inline" />
        İSG Belgesi Ekle
      </button>

      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/50 p-4 pt-24 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
            <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
              <h3 className="text-base font-semibold text-slate-900">İSG Belgesi Ekle</h3>
